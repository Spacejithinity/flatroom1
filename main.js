...
var layer_list = [
	{
		'image': background,
		'src': 'https://drive.google.com/uc?id=1E5lEOKVwg2p9MDLtZ00Id03Zzma0Y0Gk',
		'z_index': -2.25,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': clouds,
		'src': 'https://drive.google.com/uc?id=1dNOgISsOgw_JDILfTeuWZKL0-qggOuS7',
		'z_index': -2,
		'position': {x: 0, y: 0},
		'blend': 'multiply',
		'opacity': 1
	...
	{
		'image': shadows,
		'src': 'https://drive.google.com/uc?id=1ujsRE0a7GIM_EpnYbfBoIT2Z6P6GfEfD',
		'z_index': 0,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 0.75
	...
	{
		'image': mask,
		'src': 'https://drive.google.com/uc?id=1C0v0MN81BMQJb3cDwry2cL7GQ6Cm1khr',
		'z_index': 1.25,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
